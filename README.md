...
## ✨ Features
* **Global Shortcuts:** Seamlessly switch languages using combinations like `⌃ Control + Space`, `⌘ Command + Space`, or `⌥ Option + Space`.
...
* **Localization:** Fully supports both English and Korean.
...
2. Download the latest `LangSwitcher_v0.1.0.zip` file and extract it.
...
## ✨ 주요 기능
* **전역 단축키:** `⌃ Control + Space`, `⌘ Command + Space`, `⌥ Option + Space` 등 원하는 조합으로 언어를 빠르게 전환하세요.
...
2. 최신 버전의 `LangSwitcher_v0.1.0.zip` 파일을 다운로드하고 압축을 풉니다.
